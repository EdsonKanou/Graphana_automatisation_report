...
def dag_parallel_update() -> Dict:
    ...
    def parallel_deployment_group():
        ...
        Exécute plan/apply pour tous les comptes.
        """
    ...
    # ✅ CORRECTION: On chaîne les OUTPUTS des groupes (qui sont des steps)
    accounts_valid >> updated_accounts
    updated_accounts >> schematics_api_key
